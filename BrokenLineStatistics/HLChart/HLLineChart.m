...
#import "HLLineChart.h"
#define kXandYSpaceForSuperView 20.0

@interface HLLineChart ()
...
-(instancetype)initWithFrame:(CGRect)frame andLineChartType:(HLLineChartType)lineChartType{
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        _lineWidth = 0.5;
        self.contentInsets = UIEdgeInsetsMake(10,25,25,10);
...
- (void)configPerXAndPerY{
    ...
    switch (_lineChartQuadrantType) {
        case HLLineChartQuadrantTypeFirstQuardrant:
        {
            ...
            break;
        case HLLineChartQuadrantTypeFirstAndSecondQuardrant:
        {
            _perXLen = (_xLength/2-kXandYSpaceForSuperView)/[_xLineDataArr[0] count];
            _perYlen = (_yLength-kXandYSpaceForSuperView)/_yLineDataArr.count;
        }
            break;
        case HLLineChartQuadrantTypeFirstAndFouthQuardrant:
        {
            _perXLen = (_xLength-kXandYSpaceForSuperView)/(_xLineDataArr.count-1);
            _perYlen = (_yLength/2-kXandYSpaceForSuperView)/[_yLineDataArr[0] count];
        }
            break;
        case HLLineChartQuadrantTypeAllQuardrant:
        {
             _perXLen = (_xLength/2-kXandYSpaceForSuperView)/([_xLineDataArr[0] count]);
             _perYlen = (_yLength/2-kXandYSpaceForSuperView)/[_yLineDataArr[0] count];
        }
 ...
 *
 */
-(void)setLineChartQuadrantType:(HLLineChartQuadrantType)lineChartQuadrantType{
