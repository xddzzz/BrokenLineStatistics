...
#import "HLWaveChart.h"

@interface HLWaveChart()


@property (nonatomic,strong) NSArray * yLineDataArr;
@property (assign , nonatomic) HLWaveChartType  waveChartType ;
